          ...
          <div className="flex-1 w-full">
            ...
            <BlurFade delay={BLUR_FADE_DELAY * 2}>
              <p className="font-info text-sm md:text-base text-muted-foreground leading-relaxed max-w-2xl">
                I'm a student currently learning Pytorch
                and deep learning. I am interested in Natural Language Processing
                with focus on Research on implementing new designs for Language Models.
              </p>
            </BlurFade>
            ...
            <div className="mt-6">
              ...
              <BlurFade delay={BLUR_FADE_DELAY * 4}>
                <p className="font-info mt-2 text-sm md:text-base text-muted-foreground leading-relaxed max-w-3xl">
                  I started programming and quickly found it both fun and interesting. I’m driven
                  by the desire to build things that make an impact. My interests lie
